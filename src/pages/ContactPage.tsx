...
export default function ContactPage() {
  return (
    <>
      ...
      <meta
        name="description"
        content="Get in touch with Tenerife Mortgage Consultancy. We help international buyers understand their mortgage options for buying property in Spain."
      />
      <Header />
      ...
      <div className="relative bg-brand-blue py-16 text-white overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=1400&q=80')",
          }}
          aria-hidden="true"
        />
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
              <p className="uppercase text-brand-gold text-xs tracking-widest font-semibold mb-4">
                Get in touch
              </p>
              <h2 className="font-display text-2xl font-bold text-brand-blue mb-4">
                Send us your details and we will help you understand the next
                steps for financing a property purchase in Tenerife or wider
                Spain.
              </h2>
            ...
            <div className="space-y-6">
              <div className="bg-brand-blue rounded-2xl p-6 text-white">
                <h3 className="font-semibold text-brand-gold mb-2 uppercase text-xs tracking-widest">
                  Free consultation
                </h3>
                <p className="text-sm text-gray-300 leading-relaxed">
                  Our initial consultation is completely free. We'll listen to
                  your goals, explain your options and outline the steps ahead —
                  with no obligation.
                </p>
              </div>
              ...
              <div className="bg-brand-gold/10 border border-brand-gold/30 rounded-2xl p-5">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Use our mortgage calculator to get an estimate of your monthly
                  payments before we talk.
                </p>
                <a
