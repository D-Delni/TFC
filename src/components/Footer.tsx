      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="md:col-span-2">
          <div className="font-display font-bold text-xl mb-2">
            TM <span className="text-brand-gold">Tenerife</span> Mortgage Consultancy SL
          </div>
        ...
        {/* Links */}
        <div>
          <h3 className="font-semibold text-brand-gold mb-3 uppercase text-xs tracking-widest">Quick Links</h3>
